...
<script>
	...
	export default{
		...
		mounted() {
			axios.get('http://42.240.141.211/WallpaperController/simpleQueryPhoneByCategory?cid='+this.cid)
				.then(res => {
		...
		methods:{
			...
			showDetail(title){
				this.$router.push({path:'/detail', query:{category:title,flag:1,cid:this.cid}});
			}
		},
	}
</script>
